  ...
  <xsl:template name="token">
    ...
    <script>
      ...
      const result = `<div>
          ...
          <div>
            <span class="tbml-venue">${this.props.building || ''}</span>
          </div>
          <div>
            ...
            <span class="tbml-date">${this.props.time == null ? "": this.props.time.toLocaleDateString()}</span>
            ...
            <span class="tbml-date">S${this.props.section}</span>
            ...
            <span class="tbml-date">${this.props.numero}</span>
          </div>
          <div>
            <span class="tbml-time">${time}</span> <span class="tbml-time">${this.props.street || ''}</span>, <span class="tbml-time">${this.props.locality || ''}</span>, <span class="tbml-time">${this.props.state || ''}</span>, <span class="tbml-time">${this.props.country || ''}</span>
          </div>
        </div>`
		return result
      }
