    ...
    if (typeof exports === 'object') {
      ...
      return <div>
          ...
          <div>
            ...
            <span className="tbml-date">{this.props.time == null ? "": this.formatGeneralizedTimeToDate(this.props.time.generalizedTime)}</span>
        ...
        <script type="text/babel">
          if (typeof web3 == "undefined") {
            const hardcodedCurrentTokenInstance = {
              ...
              country: "SG",
              street: "STREET",
			  time: { date: new Date(), generalizedTime: new Date() },
            }
