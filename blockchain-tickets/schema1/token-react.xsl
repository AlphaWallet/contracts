  ...
  <xsl:template name="token">
    ...
    <script type="text/babel">
      ...
      return <div>
          ...
          <div>
              <span className="tbml-venue">{this.props.venue}</span>
          </div>
          <div>
            ...
            <span className="tbml-date">{this.props.countryA}-{this.props.countryB}</span>
            ...
            <span className="tbml-date">M{this.props.match}</span>
          </div>
          <div>
            <span className="tbml-time">{time}</span>, <span>{this.props.locality}</span>
          </div>
      </div>
      }
      }
